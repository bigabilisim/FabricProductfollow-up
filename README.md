...
Şablon düzenleme ve ön izleme ekranlarında `Test Mail Gönder` alanı bulunur. Girilen adrese örnek değişkenlerle render edilmiş test maili gönderilir; rapor şablonları da aynı yolla test maili olarak kontrol edilebilir.
